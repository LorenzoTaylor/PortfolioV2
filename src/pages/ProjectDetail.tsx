  ...
  if (!project) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-zinc-400 font-mono text-sm">project not found</p>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 pb-32">
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="mb-10 flex items-center gap-2 text-xs font-mono text-zinc-400 dark:text-zinc-600 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors"
        >
        ...
        <motion.div
          ...
          className="mb-10 overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800"
        >
          <img
        ...
        >
          <div className="md:col-span-2 space-y-6">
            <div className="space-y-3">
              <h2 className="text-xs font-mono text-zinc-400 dark:text-zinc-600 uppercase tracking-wider">
                Role
              </h2>
        ...
        {(project.videoUrl || project.images.length > 1) && (
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {project.videoUrl && (
                <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-950">
                  <video
              ...
              {/* Remaining screenshots (skip index 0 — already shown as hero) */}
